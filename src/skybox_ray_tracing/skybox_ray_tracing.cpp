...
int main()
{
    ...
    Shader shader(FileSystem::getPath("src/skybox_ray_tracing/skybox_ray_tracing.vs").c_str(),
         FileSystem::getPath("src/skybox_ray_tracing/skybox_ray_tracing.fs").c_str());
